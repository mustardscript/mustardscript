...
pub(super) fn limit_error(message: impl Into<String>) -> JsliteError {
    JsliteError::Message {
...
pub(super) fn serialization_error(message: impl Into<String>) -> JsliteError {
    JsliteError::Message {
...
pub(super) fn pop_many(stack: &mut Vec<Value>, count: usize) -> JsliteResult<Vec<Value>> {
    if stack.len() < count {
