...
pub(in crate::runtime) fn validate_snapshot(snapshot: &ExecutionSnapshot) -> JsliteResult<()> {
...
fn snapshot_error(message: impl Into<String>) -> JsliteError {
    JsliteError::Message {
...
fn validate_envs(runtime: &Runtime) -> JsliteResult<()> {
...
fn validate_closures(runtime: &Runtime) -> JsliteResult<()> {
...
fn validate_frame(runtime: &Runtime, frame: &Frame) -> JsliteResult<()> {
...
fn validate_iterators(runtime: &Runtime) -> JsliteResult<()> {
