...
impl Runtime {
    pub(in crate::runtime) fn activate_microtask(&mut self, job: MicrotaskJob) -> JsliteResult<()> {
    ...
    pub(in crate::runtime) fn process_idle_state(&mut self) -> JsliteResult<Option<ExecutionStep>> {
