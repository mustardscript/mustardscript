...
const FEATURE_CONTRACT = Object.freeze([
  ...
  },
  {
    ...
    title: 'default parameters match the documented parameter-scope semantics',
    outcome: OUTCOME.NODE_PARITY,
    coverage: [COVERAGE.EXISTING],
  },
  {
    id: 'validation.default-destructuring',
    title: 'default destructuring matches the documented supported surface',
    outcome: OUTCOME.NODE_PARITY,
    coverage: [COVERAGE.EXISTING],
  },
  {
  ...
  },
  {
    ...
    title: 'update expressions match the documented identifier/member surface',
    outcome: OUTCOME.NODE_PARITY,
    coverage: [COVERAGE.EXISTING],
  },
  {
  ...
  },
  {
    ...
    title: 'destructuring assignment matches the documented supported surface',
    outcome: OUTCOME.NODE_PARITY,
    coverage: [COVERAGE.EXISTING],
  },
  {
  ...
  },
  {
    ...
    title: 'instanceof matches the documented conservative constructor surface',
    outcome: OUTCOME.NODE_PARITY,
    coverage: [COVERAGE.EXISTING],
  },
  {
    id: 'validation.instanceof-guest-function',
    title: 'instanceof with a guest function constructor returns false conservatively',
    outcome: OUTCOME.NODE_PARITY,
    coverage: [COVERAGE.EXISTING],
  },
  {
