...
export function CTASection() {
  return (
    <section className="bg-mustard relative overflow-hidden">
      {/* Subtle dot texture */}
      <div
      ...
      <div className="relative max-w-2xl mx-auto text-center px-6 py-20">
        <h2 className="font-heading text-3xl sm:text-4xl font-bold text-black mb-3 tracking-tight">
